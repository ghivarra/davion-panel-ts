...
// import libs
import { ref, inject, defineEmits, computed, onMounted } from 'vue'
...
const profilePicture = computed(() => {
    return (typeof admin?.photo === 'undefined' || admin?.photo === null || admin?.photo.length < 1) ? imageUrl('admin/default-user.png', 120) : imageUrl(`admin/${admin.photo}`, 120)
})
